    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        if in_stage_geometry:
            if has_loaded_normal_prior:
                ...
                lambda_multi_view_ncc_cur = 0.2 + (0.02 - 0.2) * stage_progress
                lambda_normal_prior_cur = 0.1 + (0.3 - 0.1) * stage_progress
            else:
        ...
        depth_render_on = depth_normal_loss_kick_on or normal_prior_kick_on or stage_cfg.enable_ncc_geo
        ...
        # patch match loss
        if patchmatch is not None and stage_cfg.enable_ncc_geo and (lambda_multi_view_ncc_cur > 0 or opt.lambda_multi_view_geo > 0):
            nearest_cam = (
                None
...
if __name__ == "__main__":
    ...
    stage2_end_iter = 12000
    stage3_start_iter = stage2_end_iter + 1
    stage3_use_depth_normal = False  # Manual toggle for Stage-3 depth-normal loss.
